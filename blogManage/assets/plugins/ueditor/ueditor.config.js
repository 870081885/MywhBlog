...
//        ]]
        , toolbars: [[
            ...
            'link', 'unlink', '|', 'emotion', 'simpleupload', 'insertvideo', '|', 'map',
            '|', 'insertcode', 'pasteplain', '|', 'horizontal', 'print', 'preview', 'fullscreen', 'drafts'
        ]]
		...
		,whitList: {
            ...
            embed: ['type', 'class', 'pluginspage', 'src', 'width', 'height', 'align', 'style', 'wmode', 'play',
                +  'autoplay', 'loop', 'menu', 'allowscriptaccess', 'allowfullscreen', 'controls', 'preload', 'quality', 'flashvars'],
